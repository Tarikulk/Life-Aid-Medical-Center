...
const Subscribe = () => {
    return (
        <div className='my-20 mx-5 md:mx-20'>
            <div className="w-full dark:bg-gray-500 rounded-lg" style={{backgroundImage:`url(${appointment})`}}>
	<div className="container flex flex-col flex-wrap content-center justify-center p-4 py-20 mx-auto md:p-10">
		...
		<div className="flex flex-row">
			...
			<button type="button" className="w-2/5 p-3 font-semibold rounded-r-lg sm:w-1/3 bg-gradient-to-r from-primary to-secondary text-white">Subscribe</button>
		</div>
	</div>
</div>
        </div>
